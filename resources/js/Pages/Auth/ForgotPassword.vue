        ...
        <div class="w-full max-w-md p-8 bg-white rounded-lg shadow-lg bg-opacity-90">
            ...
            <div class="mb-4 relative">
                <TextInput
                    id="empmail"
                    type="email"
                    class="block w-full p-3 pr-12 text-sm border-gray-300 rounded-md"
                ...
                <div class="flex items-center justify-center mt-4">
                    <PrimaryButton :class="{ 'opacity-25': form.processing || isLoading }" :disabled="form.processing || isLoading" class="mt-4 py-2 px-12 font-semibold text-white rounded-md bg-gradient-to-r from-blue-500 to-blue-600 hover:from-blue-600 hover:to-blue-700">
